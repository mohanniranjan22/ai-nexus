        ...
        <SidebarGroup>
          <div className="p-3">
            ...
            {chatHistory?.map((chat, index) => (
              <Link href={"?chat=" + chat.chatId} key={index} className="mt-2">
                <div className=" hover:bg-gray-100 p-3 cursor-pointer">
                  <h2 className="text-sm text-gray-400">
                    {const obj=GetLastUserMessageFromChat(chat)?.lastMsgDate}
                  </h2>
...
//       const chat = doc.data();
//       const chatSummary = await GetLastUserMessageFromChat(chat);
...
//             {chatHistory.map((chat, index) => (
//               <Link href={`?chat=${chat.chatId}`} key={index} className="mt-2">
//                 <div className="hover:bg-gray-100 p-3 cursor-pointer rounded-lg">
//                   <h2 className="text-sm text-gray-400">{chat.lastMsgDate}</h2>
//                   <h2 className="text-lg line-clamp-1">{chat.message}</h2>
//                   <hr className="my-3" />
//                 </div>
//               </Link>
//             ))}
